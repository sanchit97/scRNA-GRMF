function [labels] = get_numeric_labels_Zeisel()

data_dir='../Data/'

load([data_dir 'annotations/Zeisel_annotations.mat']); %anno=csvread([data_dir 'annotations/Kolodziejczyk_annotations.csv']);
gt_labels=anno;
