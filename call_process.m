function call_process(data,varargin)
...
dataname='NEWDATA'; gene_names=[]; gene_ids=[]; pro_dir='./Data/Processed Data/';

if ~exist('Temp','dir'), mkdir Temp; end
% if ~exist(pro_dir,'dir'), mkdir processedData; pro_dir=['./Data/Processed Data/' dataname '_processed.mat']; end
